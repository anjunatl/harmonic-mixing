...
describe('mixer', () => {
  ...
  test('gets the correct relative mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.relative })
  ...
  test('gets the correct dominant mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.dominant })
  ...
  test('gets the correct subdominant mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.subdominant })
  ...
  test('gets the correct parallel mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.parallel })
  ...
  test('gets the correct diagonal mix for an A track', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.diagonal })
    expect(mix.newMix.number).toBe(11)
    expect(mix.newMix.letter).toBe("B")
  })
  ...
  test('gets the correct gentle boost mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.gentleBoost })
  ...
  test('gets the correct rapid boost mix', () => {
    let testMix = CamelotMixer.getMixesFor("12A")
    let mix = _.findWhere(testMix.possibleMixes, { type: CamelotMixer.Types.rapidBoost })
